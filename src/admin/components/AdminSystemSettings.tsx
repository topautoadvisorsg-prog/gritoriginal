...
import { Settings, Save, Loader2, AlertTriangle, Database, Key, Zap } from 'lucide-react';
            ...
            <CardContent className="space-y-8">
                {isLoading ? (
                    ...
                    <>
                        ...
                        {/* Data Engine Sync Configuration */}
                        <DataEngineConfigSection />

                        {/* Supabase Outbound Sync Configuration */}
                        <SupabaseConfigSection />

                        {/* External API Keys (Anthropic, Brave, Nano Banana) */}
                        <ApiKeysConfigSection />

                        <div className="pt-4 border-t">
                            <p className="text-xs text-muted-foreground italic">
                                Note: All keys are stored securely in the database and never exposed in logs.
                            </p>
                        </div>
                    </>
                )}
        ...
        <div className="space-y-4 pt-6 border-t">
            ...
            <div className="grid gap-4 p-4 border rounded-lg bg-muted/10">
                {SUPABASE_FIELDS.map((field) => {
                    ...
                    const isConfigured = !!q.data?.value;
                    return (
