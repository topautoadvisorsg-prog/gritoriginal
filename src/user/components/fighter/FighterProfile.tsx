...
function getFieldChecks(fighter: Fighter): FieldCheck[] {
  return [
    ...
    { label: 'Height (inches)', value: fighter.physicalStats?.height_inches },
    { label: 'Reach (inches)', value: fighter.physicalStats?.reach_inches },
    { label: 'Weight (lbs)', value: fighter.physicalStats?.weight },
