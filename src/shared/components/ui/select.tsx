...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ...
    className={cn(
      ...
      "hover:border-input",
      "focus:outline-none focus:border-[hsl(190_90%_55%/0.6)] focus:ring-[3px] focus:ring-[hsl(190_90%_55%/0.15)]",
      "data-[state=open]:border-[hsl(190_90%_55%/0.5)]",
  ...
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ...
      className={cn(
        ...
        "shadow-[0_12px_40px_-12px_rgba(0,0,0,0.85),inset_0_1px_0_rgba(255,255,255,0.04)]",
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ...
    className={cn(
      ...
      "focus:bg-[hsl(190_90%_55%/0.12)] focus:text-foreground",
      "data-[state=checked]:text-[hsl(190_90%_70%)] data-[state=checked]:font-semibold",
      className,
    )}
    {...props}
  >
